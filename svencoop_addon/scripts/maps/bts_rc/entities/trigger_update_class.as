        ...
        void Use( CBaseEntity@ pActivator, CBaseEntity@ pCaller, USE_TYPE useType, float flValue )
        {
            ...
            switch( m_loadout )
            {
                ...
                case LoadOut::Solo:
                {
                    ...
                    switch( Math.RandomLong( 1, 36) )
                    {
					    ...
					    case 31:
                        {
							...
							g_PlayerFuncs.SayText(player, "You have: Random: WHACK-A-MOLE.\n");
							player.GetUserData()["pm"] = "bts_op5";
                            break;
                        }
						case 32:
                        {
							...
							g_PlayerFuncs.SayText(player, "You have: Random: MASTER CARD.\n");
							player.GetUserData()["pm"] = "bts_op6";
                            break;
						}
						case 33:
                        {
							...
							g_PlayerFuncs.SayText(player, "You have: Random: HELLBOUNDED. (get fucked)\n");
							player.GetUserData()["pm"] = "bts_op_hurt";
                            break;
                        }
						case 34:
                        {
							...
							g_PlayerFuncs.SayText(player, "You have: Random: LVL 5 SECURITY.\n");
							g_PlayerClass.set_class( player, PM::VETERAN );
						...
						case 35:
                        {
							...
							g_PlayerFuncs.SayText(player, "You have: Random: NICHE INTERESTS");
							player.GetUserData()["pm"] = "bts_op_back";
                            break;
                        }
					    case 36:
                        {
                            ...
                            g_PlayerFuncs.HudMessage( player, msgParams, "RANDOM USER MODE SELECTED\nGEAR NAME: NEPOTISM" );
							g_PlayerFuncs.SayText(player, "You have: Random: NEPOTISM.\n");
                ...
                case LoadOut::Scientist:
                {
					...
					switch( Math.RandomLong( 1, 3 ) )
                    {
                        case 1:
                        {
							...
							g_PlayerFuncs.SayText(player, "Scientist: Screwdriver\n");
                            break;
                        }
						case 2:
                        {
                            ...
                            g_PlayerFuncs.HudMessage( player, msgParams, "Blackmesa Science Team" );
							g_PlayerFuncs.SayText(player, "Scientist: Broom\n");
                            break;
                        }
						case 3:
                        {
                            ...
                            g_PlayerFuncs.HudMessage( player, msgParams, "Blackmesa Science Team" );
							g_PlayerFuncs.SayText(player, "Scientist: Extra Care\n");
                            break;
                        }
					} 
                    AddKeyCard( player, {
                ...
                case LoadOut::Constructor:
                {
					...
					switch( Math.RandomLong( 1, 3 ) ) // sorry
                    {
                        case 1:
						AddItems( player, {
						...
						g_PlayerFuncs.SayText(player, "Maintenance: Spanner.\n");
						break;
                    }
                    AddKeyCard( player, {
                        { "skin", "4" },
