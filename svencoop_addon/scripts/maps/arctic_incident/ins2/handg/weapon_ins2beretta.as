...
// Models
string W_MODEL = "models/arctic_incident/w_m92fs_ai.mdl";
string V_MODEL = "models/arctic_incident/white_hevarms/v_m92fs_ai.mdl";
string P_MODEL = "models/arctic_incident/p_m92fs_ai.mdl";
string A_MODEL = "models/arctic_incident/ins2/ammo/mags.mdl";
int MAG_BDYGRP = 1;
// Sprites
string SPR_CAT = "arctic_incident/ins2/hdg/"; //Weapon category used to get the sprite's location
// Sounds
string SHOOT_S = "arctic_incident/ins2/wpn/m92fs/shoot.ogg";
string EMPTY_S = "arctic_incident/ins2/wpn/m92fs/empty.ogg";
// Information
int MAX_CARRY   	= 1000;
int MAX_CLIP    	= 15;
...
class weapon_ins2beretta : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	private array<string> Sounds = {
		"arctic_incident/ins2/wpn/m92fs/sldbk.ogg",
		"arctic_incident/ins2/wpn/m92fs/sldrel.ogg",
		"arctic_incident/ins2/wpn/m92fs/hit.ogg",
		"arctic_incident/ins2/wpn/m92fs/magin.ogg",
		"arctic_incident/ins2/wpn/m92fs/magout.ogg",
		"arctic_incident/ins2/wpn/m92fs/magrel.ogg",
		SHOOT_S,
		EMPTY_S
	};
