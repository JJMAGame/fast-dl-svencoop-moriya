...
const string EMPTY_SHOOT_S = "arctic_incident/ins2/wpn/empty.ogg"; //Default Empty shoot sound, if your weapons doesn't have any empty sound, it will use this
const string AMMO_PICKUP_S = "arctic_incident/ins2/wpn/ammo.ogg"; //Default ammo pickup sound
const string FIREMODE_SPRT = "arctic_incident/ins2/firemodes.spr"; //Default firemodes sprite for weapons that support it
const string BIPODMOD_SPRT = "null.spr";
const string WEAP_SPRT_S01 = "arctic_incident/ins2/wpn1024.spr"; //Sprite file that the weapon will precache

//Bullet types
const string BULLET_9x19 	= "models/arctic_incident/ins2/shells/9mm.mdl";
const string BULLET_762x51 	= "models/arctic_incident/ins2/shells/308.mdl";

// For Deploy Sounds
const array<string> DeployFirearmSounds = {
	"arctic_incident/ins2/wpn/fdraw1.ogg",
	"arctic_incident/ins2/wpn/fdraw2.ogg",
	"arctic_incident/ins2/wpn/fdraw3.ogg",
	"arctic_incident/ins2/wpn/fdraw4.ogg",
	"arctic_incident/ins2/wpn/fdraw5.ogg",
	"arctic_incident/ins2/wpn/fdraw6.ogg"
};
const array<string> DeployPistolSounds = {
	"arctic_incident/ins2/wpn/pdraw1.ogg",
	"arctic_incident/ins2/wpn/pdraw2.ogg",
	"arctic_incident/ins2/wpn/pdraw3.ogg",
	"arctic_incident/ins2/wpn/pdraw4.ogg",
	"arctic_incident/ins2/wpn/pdraw5.ogg"
};
...
const array<string> AimDownSights_in = {
	"arctic_incident/ins2/wpn/in1.ogg",
	"arctic_incident/ins2/wpn/in2.ogg",
	"arctic_incident/ins2/wpn/in3.ogg"
};
const array<string> AimDownSights_out = {
	"arctic_incident/ins2/wpn/out1.ogg",
	"arctic_incident/ins2/wpn/out2.ogg",
	"arctic_incident/ins2/wpn/out3.ogg"
};
...
mixin class ExplosiveBase
{
	...
	string FUSELOOP = "";
	protected string SPR_EXPLOSION = "";
