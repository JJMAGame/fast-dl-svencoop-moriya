...
// Models
string W_MODEL = "models/arctic_incident/w_fnfal_ai.mdl";
string V_MODEL = "models/arctic_incident/white_hevarms/v_fnfal_ai.mdl";
string P_MODEL = "models/arctic_incident/p_fnfal_ai.mdl";
string A_MODEL = "models/arctic_incident/ins2/ammo/mags.mdl";
int MAG_BDYGRP = 3;
// Sprites
string SPR_CAT = "arctic_incident/ins2/brf/"; //Weapon category used to get the sprite's location
// Sounds
string SHOOT_S = "arctic_incident/ins2/wpn/fnfal/shoot.ogg";
string EMPTY_S = "arctic_incident/ins2/wpn/fnfal/empty.ogg";
// Information
int MAX_CARRY   	= 1000;
int MAX_CLIP    	= 20;
...
class weapon_ins2fnfal : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	private array<string> Sounds = {
		"arctic_incident/ins2/wpn/fnfal/bltbk.ogg",
		"arctic_incident/ins2/wpn/fnfal/bltrel.ogg",
		"arctic_incident/ins2/wpn/fnfal/rof.ogg",
		"arctic_incident/ins2/wpn/fnfal/magin.ogg",
		"arctic_incident/ins2/wpn/fnfal/magout.ogg",
		"arctic_incident/ins2/wpn/fnfal/magrtl.ogg",
		"arctic_incident/ins2/wpn/fnfal/magrel.ogg",
		EMPTY_S,
		SHOOT_S
	};
